    ...
    <div class="container body">
      <div class="main_container">
        ...
        <?php
          ...
          $no = 1;    
          //Data Responden           
            $sql = "SELECT * FROM responden WHERE LEFT(tanggal,7)>='$tahun-04' AND LEFT(tanggal,7)<='$tahun-06' ORDER BY tanggal asc";
        ...
        <div class="row" style="display: inline-block;" >
          ...
          <div class="">
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Data SKM dan IPAK Triwulan 2 Tahun <?=$tahun?></h2>
