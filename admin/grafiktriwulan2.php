...
<head>
    ...
    <title>Data Triwulan 2 - Tahun <?=$tahun?></title>
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <?php
          ...
          $no = 1;    
          //Jumlah Responden               
            $sql1 = "SELECT id from responden where left(tanggal,7)>='$tahun-04' and left(tanggal,7)<='$tahun-06'";
            $query1 = mysqli_query($con, $sql1) or die(mysqli_connect_error());
            $data1 = mysqli_fetch_assoc($query1);
            $count1 = mysqli_num_rows($query1);

          //Total SKM
            $sql2 = "SELECT * FROM responden where left(tanggal,7)>='$tahun-04' and left(tanggal,7)<='$tahun-06'";
          ...
          //Total IPAK
            $sql3 = "SELECT * FROM responden where left(tanggal,7)>='$tahun-04' and left(tanggal,7)<='$tahun-06'";
...
function total($col,$val){
    ...
    $s = "SELECT count(*) from responden where $col='$val' AND left(tanggal,7)>='$tahun-04' and left(tanggal,7)<='$tahun-06'";
...
function usia($val){
  ...
  $s = "SELECT count(*) from responden where $cond AND left(tanggal,7)>='$tahun-04' and left(tanggal,7)<='$tahun-06'";
  $q = mysqli_query($con, $s) or die(mysqli_connect_error());
  $d = mysqli_fetch_assoc($q);
  return $d['count(*)'];
}
