          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Data SKM dan IPAK Triwulan 3 Tahun <?=$tahun?></h2>
                  ...
                  <?php
                  include ('../koneksi.php');                    
                    $sql = "SELECT * FROM responden WHERE LEFT(tanggal,7)>='$tahun-07' AND LEFT(tanggal,7)<='$tahun-09' ORDER BY tanggal asc";
