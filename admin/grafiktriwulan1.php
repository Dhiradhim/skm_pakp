...
function total($col,$val){
    ...
    $s = "SELECT count(*) from responden where $col='$val' AND left(tanggal,7)>='$tahun-01' and left(tanggal,7)<='$tahun-03'";
...
function usia($val){
  ...
  $s = "SELECT count(*) from responden where $cond AND left(tanggal,7)>='$tahun-01' and left(tanggal,7)<='$tahun-03'";
  $q = mysqli_query($con, $s) or die(mysqli_connect_error());
  $d = mysqli_fetch_assoc($q);
  return $d['count(*)'];
}
